// DAB Classic v3: portiert aus Qt-DAB sources/backend/data/data-processor.cpp
// (Jan van Katwijk, GPLv2+), siehe data-processor.h.
#
/*
...
//	fragmentsize == Length * CUSize
	dataProcessor::dataProcessor	(const packetdata	*pd,
	                                 BackendCallbacks	*cb):
	...
	switch (DSCTy) {
	   ...
	   case 60:
	      my_dataHandler. reset (new motHandler (cb, SId));
	      break;
	}
	assembling	= false;
	last_cntIdx	= 0;
