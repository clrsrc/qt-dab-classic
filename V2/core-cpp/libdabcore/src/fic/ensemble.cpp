// DAB Classic v3: portiert aus Qt-DAB sources/frontend/fic-handling/ensemble.cpp (Jan van Katwijk, GPLv2+), Qt entfernt: QObject/Signale -> ReceiverCallbacks, QString -> std::string (UTF-8), QMutex -> std::mutex; FIG-Auswertung unveraendert.
#
/*
