// DAB Classic v3: portiert aus Qt-DAB sources/frontend/correlator.cpp
// (Jan van Katwijk, GPLv2+), Qt entfernt – siehe correlator.h.
#
/*
...
/**
  ...
  */
	...
	correlator::correlator (processParams	*p,
	                        phaseTable 	*theTable) :
	                             params (p -> dabMode),
