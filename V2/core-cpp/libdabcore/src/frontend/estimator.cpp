// DAB Classic v3: portiert aus Qt-DAB sources/frontend/estimator.cpp
// (Jan van Katwijk, GPLv2+), Qt entfernt – siehe estimator.h.
#
/*
...
/**
  */
	...
	estimator::estimator (processParams	*p,
	                      phaseTable 	*theTable) :
	                             params (p -> dabMode),
