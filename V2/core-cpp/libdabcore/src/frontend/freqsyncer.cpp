// DAB Classic v3: portiert aus Qt-DAB sources/frontend/freqsyncer.cpp
// (Jan van Katwijk, GPLv2+), Qt entfernt – siehe freqsyncer.h.
#
/*
...
#include	<vector>
	...
	freqSyncer::freqSyncer (processParams	*p,
	                                phaseTable	*theTable):
	                                     params (p -> dabMode),
