// DAB Classic v3: portiert aus Qt-DAB sources/frontend/tii-detector-1.cpp (Jan van Katwijk / Rolf Zerr, GPLv2+), Qt entfernt: QVector -> std::vector, sonst unveraendert.
#
/*
