// DAB Classic v3: portiert aus Qt-DAB sources/frontend/tii-detector-1.h (Jan van Katwijk / Rolf Zerr, GPLv2+), Qt entfernt: QVector -> std::vector, sonst unveraendert.
#
/*
...
public:
	...
	std::vector<tiiData>	processNULL	(int16_t, uint8_t);
