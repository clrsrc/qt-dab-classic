// DAB Classic v3: portiert aus Qt-DAB sources/backend/data/mot/mot-dir.h
// (Jan van Katwijk, GPLv2+): QObject gestrichen, RadioInterface ->
// BackendCallbacks. Verzeichnis-Reassembly unveraendert.
#
/*
 *    Copyright (C) 2025
