// DAB Classic v3: portiert aus Qt-DAB sources/support/dab-constants.h
// (Jan van Katwijk, GPLv2+), Qt entfernt: QString -> std::string,
// Windows-/Qt-Includes gestrichen, GUI-Konstanten entfallen.
#
/*
...
//	Decoder-Auswahl des ofdmDecoders (v1: main/radio.h)
