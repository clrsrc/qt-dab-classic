...
//	Timer, Recording, EWF, GUI mode settings
#define	TIMER_HANDLING		"TIMER_HANDLING"
#define	TIMER_FILE		"timerFile"
#define	RECORDING_HANDLING	"RECORDING"
...
#define	WINAMP_DOCK		"WINAMP_DOCK"
